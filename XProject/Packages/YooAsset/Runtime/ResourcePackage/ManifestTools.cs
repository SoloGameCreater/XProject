...
namespace YooAsset
{
    internal static class ManifestTools
    {
        ...
        public static void Encrypt(string savePath)
        {
            byte[] bytesData = FileUtility.ReadAllBytes(savePath);
            bytesData = YooEncryptDecrypt.EncryptBytes(bytesData);
        ...
        public static byte[] Decrypt(byte[] binaryData)
        {
            return YooEncryptDecrypt.DecryptBytes(binaryData);
        }
#endif
