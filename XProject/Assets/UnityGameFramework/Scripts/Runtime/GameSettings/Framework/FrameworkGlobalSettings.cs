...
public class ResourcesArea
{
    ...
    [Tooltip("Android版本")] [SerializeField] private string m_AndroidVersion = "v1_0_0";

    public string AndroidVersion
    {
        get { return m_AndroidVersion; }
    }
    
    [Tooltip("iOS版本")] [SerializeField] private string m_IOSVersion = "v1_0_0";

    public string IOSVersion
    {
        get { return m_IOSVersion; }
    }
}
