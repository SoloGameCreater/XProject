...
var Builder = require('./BuilderUtilsConfigHub');
...
var outputConfig = new Builder.OutputConfig(program.args[1], program.args[2], program.args[3], program.args[4], program.args[5], program.args[6], program.args[7], program.args[8]);
