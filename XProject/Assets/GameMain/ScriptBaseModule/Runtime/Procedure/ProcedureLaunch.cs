...
namespace BaseModule
{
    ...
    public class ProcedureLaunch : ProcedureBase
    {
        ...
        private void InitDebuggerSettings()
        {
#if DEBUG || DEVELOPMENT_BUILD
            Debug.unityLogger.logEnabled = true;
            //if (Debug.isDebugBuild) GameObject.DontDestroyOnLoad(GameObject.Instantiate(Resources.Load<GameObject>("Debug/SRDebug")));
#else
        ...
        private void InitLanguageSettings()
        {
            ...
            if (GameModule.Setting.HasSetting(Constant.Setting.Language))
            {
                ...
                {
                    Debug.LogError($"Init language error, reason {exception}");
                }
            }
            ...
            Debug.Log($"Init language settings complete, current language is '{language}'.");
        }
