...
namespace YooAsset
{
    ...
    public class YooAssetSettings : ScriptableObject
    {
        ...
        /// <summary>
        /// Android 默认的YooAsset文件夹名称
        /// </summary>
        public string AndroidDefaultYooFolderName = "assetpack";
        
        /// <summary>
        /// IOS 默认的YooAsset文件夹名称
        /// </summary>
        public string IOSDefaultYooFolderName = "f6d808864443";
        ...
        public string DefaultYooFolderName
        {
            ...
            {
#if UNITY_ANDROID
                return AndroidDefaultYooFolderName;
#else
                return IOSDefaultYooFolderName;
#endif
            }
        }
