...
namespace GameFramework.Sound
{
    ...
    internal sealed partial class SoundManager : GameFrameworkModule, ISoundManager
    {
        ...
        public int PlaySound(string soundAssetName, string soundGroupName, int priority, PlaySoundParams playSoundParams, object userData)
        {
            ...
            // m_ResourceManager.LoadAssetAsync(soundAssetName, priority, m_LoadAssetCallbacks, PlaySoundInfo.Create(serialId, soundGroup, playSoundParams, userData));
            AudioClip audio = (AudioClip)m_ResourceManager.LoadAsset<AudioClip>(soundAssetName);
            m_LoadAssetCallbacks.LoadAssetSuccessCallback(soundAssetName, audio, 0f, PlaySoundInfo.Create(serialId, soundGroup, playSoundParams, userData));
            return serialId;
        }
