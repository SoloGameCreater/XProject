...
exports.OutputConfig = function(unityScriptDir, classTemplate, nameSpace, managerClassTemplate, jsonPath, filters) {
	this.unityScriptDir = unityScriptDir;
	this.classTemplate = classTemplate;
	this.nameSpace = nameSpace;
	this.managerClassTemplate = managerClassTemplate;
	this.jsonPath = jsonPath;
	console.log('filters', jsonPath, filters);
	var ret = filters.split(':');
	if (ret.length != 2) {
		this.filterType = 'any';
	} else {
		this.filterType = ret[0];
		this.filters = ret[1].split('|');
	}
}
