...
//     }
    ...
    {
        return $"{CompleteDownLoadPath}/{GetPlatformName()}/{DownloadVersion}".Replace("\\", "/");
    }
    ...
    public static string CompleteDownLoadPath
    {
        ...
        {
            string url = "";
            if (ResourcesArea.ServerType == ServerTypeEnum.Intranet)
            {
    ...
    public static string DownloadVersion
    {
        ...
        {
#if UNITY_ANDROID
            return ResourcesArea.AndroidVersion;
#else
            return ResourcesArea.IOSVersion;
#endif
        }
    }
